...
<div class="mt-6 rounded-2xl bg-white p-4 shadow-sm ring-1 ring-slate-100">
  ...
  <a href="<?= e(url('purchases/create')) ?>" class="mt-3 inline-flex items-center gap-2 rounded-xl bg-slate-700 px-4 py-2 text-sm font-semibold text-white"><?= ui_icon('pencil', 'h-4 w-4') ?> Enter purchase manually</a>
</div>
